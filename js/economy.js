...
function processSalario() {
  ...
  // Proteção: inicializa ultimoPagamento se estiver ausente
  if (typeof game.ultimoPagamento === 'undefined') {
    game.ultimoPagamento = 0;
  }
...
function checkPromocao() {
  if (!game || typeof game.nivel === 'undefined') return;
